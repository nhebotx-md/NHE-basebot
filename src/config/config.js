/**
 * =========================================
 * 📌 FILE: src/config/config.js (RECONSTRUCTED)
 * 📌 DESCRIPTION:
 * File konfigurasi global untuk bot WhatsApp
 * Versi Clean Architecture
 *
 * Berisi:
 * - Owner configuration
 ...
 * - Message templates
 *
 * 📁 MAPPING: config.js (original) → src/config/config.js
 * =========================================
 */
...
// =========================================
// 📌 GLOBAL VARIABLES / CONFIG - MODE
// =========================================

// Self mode (hanya owner yang bisa pakai)
global.self = false;
