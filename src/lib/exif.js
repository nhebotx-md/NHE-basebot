/**
 * =========================================
 * 📌 FILE: src/lib/exif.js (RECONSTRUCTED)
 * 📌 DESCRIPTION:
 * Sticker processing utilities
 * Konversi gambar/video ke webp dan manajemen exif
 *
 * 📁 MAPPING: Library/exif.js (original) → src/lib/exif.js
 * =========================================
 */
